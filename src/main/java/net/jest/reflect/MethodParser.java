...
public class MethodParser {
    ...
    public Function<Request, Response> parse(@NonNull Controller controller, @NonNull Object instance, @NonNull java.lang.reflect.Method method) {
        ...
        return request -> {
            ...
            try
            {
                if (method.getReturnType().isAssignableFrom(Response.class) || method.getReturnType().equals(Response.class)) return (Response) (parametersInvoke.isEmpty() ? method.invoke(instance) : method.invoke(instance, parametersInvoke.toArray(new Object[1])));
