    ...
    public Function<Request, Response> parse(@NonNull Controller controller, @NonNull Object instance, @NonNull java.lang.reflect.Method method) {
        ...
        return request -> {
            ...
            if (auth != null
                ...
                return ResponseUtil.createResponse(ResponseUtil.UNAUTHORIZED, "Can't authorize your request. Please read api documentation. (The message is generated by the Jest framework)");
            }
